  ...
  const features = [
    {
      ...
      description: 'Round-the-clock cybersecurity monitoring and instant threat response',
    ...
    },
    {
      ...
      description: 'Advanced artificial intelligence for immediate cyber threat analysis',
    ...
    },
    {
      ...
      description: 'Direct connection to certified cybersecurity professionals worldwide',
        ...
        <LinearGradient
          ...
          <View style={styles.header}>
            <View style={[styles.logoContainer, {
              ...
              <Shield size={isTablet ? 50 : 40} color="#ffffff" strokeWidth={2} />
            ...
            <Text style={[styles.tagline, { 
              ...
              Your trusted cybersecurity companion for complete digital protection
            </Text>
            ...
            <LinearGradient
              ...
              <View style={styles.ctaContent}>
                ...
                <View style={styles.ctaTextContainer}>
                  ...
                  <Text style={styles.ctaSubtext}>AI-powered cybersecurity assistant</Text>
                </View>
